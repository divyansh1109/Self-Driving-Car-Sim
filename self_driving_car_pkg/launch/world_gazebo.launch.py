...
def generate_launch_description():
    ...
    models_pkg_share_dir = get_package_share_directory('sdc_models_pkg')
    models_share_dir = os.pathsep + os.path.join(models_pkg_share_dir, 'models')
    ...
    red_light_sdf = os.path.join(models_pkg_share_dir,'models','light_red/model.sdf')
    yellow_light_sdf = os.path.join(models_pkg_share_dir,'models','light_yellow/model.sdf')
    green_light_sdf = os.path.join(models_pkg_share_dir,'models','light_green/model.sdf')
